...
const formRules = computed<FormRules>(() => ({
  platformTypeId: [{ required: true, message: t('platform.form.typeRequired'), trigger: 'change' }],
  platformCode: [{ required: true, message: t('platform.form.codeRequired'), trigger: 'blur' }],
  platformName: [{ required: true, message: t('platform.form.nameRequired'), trigger: 'blur' }],
}))
...
async function handleDelete(row: Platform) {
  try {
    await ElMessageBox.confirm(
      t('platform.message.confirmDelete', { name: row.platformName }),
      t('common.confirm'),
      { type: 'warning' }
    )
